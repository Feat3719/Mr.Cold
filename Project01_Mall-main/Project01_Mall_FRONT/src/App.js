...
import QnABoard from './MainPage/Category/Board/QnABoard';
import Writer from './MainPage/Category/Board/Writer';
import ReadQnA from './MainPage/Category/Board/ReadQnA';
  ...
  return (
    <Router>
      ...
      <Routes>
          ...
          <Route path="/Community/QA/ReadQnA" element={
            <div>
            <Header />
            <ReadQnA />
            <Footer />
