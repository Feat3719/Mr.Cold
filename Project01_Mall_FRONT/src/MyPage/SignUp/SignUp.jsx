...
function SignUp() {
   ...
   const [check1, setCH1] = useState(false);
   const [check2, setCH2] = useState(false);
   const [check3, setCH3] = useState(false);
    ...
    const onCH1Handler = (et) => {
        setCH1(et.currentTarget.value);
        

        if  (form['check1'].checked==true){
            form['check2'].checked=true;
            form['check3'].checked=true;
            
           }else{
            form['check2'].checked=false;
            form['check3'].checked=false;
           }
    }

    const onCH2Handler = (et) => {
        setCH2(et.currentTarget.value);
    }
    const onCH3Handler = (et) => {
        setCH3(et.currentTarget.value);
    }
    ...
    const onSubmit = async function(e) {
        ...
        if(!idCon.test(ID)) {
            alert("아이디를 다시 입력해주세요.(영문자로 시작해야하고, 5~10글자 길이의 영문자와 숫자의 조합으로 표현됩니다.)");
            return false;            
        }
        if(!pwCon.test(PW)) {
        ...
        if(form['check2'].checked==false ||  form['check3'].checked==false){
            alert("약관에 동의해주세요.")
            return false;
        }
        ...
        try {
            ...
            if (response.data.success == true) {
                ...
                const con = window.confirm("지금 바로 로그인 하시겠습니까?");
                if(con) {
                    window.location.href = '/SignIn';
                } else window.location.href = '/main';  
                 
            } else {
               if(response.data.errorMessage == "이미 사용중인 아이디입니다.") {
                    alert(response.data.errorMessage)
                    document.getElementById("input_ID").focus()
               }
               if(response.data.errorMessage == "이미 사용중인 연락처입니다.") {
                    alert(response.data.errorMessage)
                    document.getElementById("input_CONTACT").focus()
               }
        ...
        <div className={style.Body}>
            ...
            <form className={style.Form} onSubmit={onSubmit} id='form'>
                <table className={style.Table}>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type='text' placeholder='아이디' onChange={onIDHandler} id="input_ID"></input> <span>영문자로 시작하고, 5~10 길이의 영문자와 숫자</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type='password' placeholder='비밀번호'onChange={onPWHandler}></input> <span>영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 7자~12자</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type='password' placeholder='비밀번호'onChange={onPW2Handler}></input> 
                               
                                {PW2==''?(''): PW!=PW2 ? (<span className={style.notpass}> !!! 비밀번호가 일치하지 않습니다 !!!
                        ...
                        <tr>
                            ...
                            <td>
                                <input type='text' placeholder='이메일' onChange={onEMAILHandler} id="input_EMAIL" ></input>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {/* <select name='input_CONTACT1' onChange={onCONTACTHandler}>
                                    <option value="010" defaultValue='010'>010</option>
                                ...
                                {/* <input type='text' placeholder='연락처' onChange={onCONTACT2Handler} maxLength={4} name='input_CONTACT2'></input> */}
                                <input type='text' placeholder='연락처' onChange={onCONTACTHandler} maxLength={11} id="input_CONTACT" ></input> <span> '-' 제외하고 숫자만 입력 </span>
                        ...
                        {/* <tr className={style.AdressRow}>
                            ...
                            <td>                        <input type='text' placeholder='우편번호' name='zipCode' disabled></input>
                                <button id={style.AdressButton} onClick={null}></button>
                            </td>
                        ...
                        <tr className={style.AdressRow}>
                            ...
                            <td>                        <input type='text' placeholder='주소' onChange={onADDRESSHandler} name='input_ADDRESS' ></input>
                            </td>
                        </tr>

                        {/* <tr className={style.AdressRow}>
                            <td>                        <input type='text' placeholder='상세주소' name='' ></input>
                            </td>
                ...
                <div className={style.Terms}>
                    <label ><input type='checkbox' className={style.CheckBoxText} name='check1' id='checkAll' onChange={onCH1Handler}></input>
                        <i className={`fa-regular fa-square-check ${style.notChecked}`} ></i>
                        <i className={`fa-solid fa-square-check ${style.Checked}`}></i>
                        <h1> 이용약관 및 개인정보수집 및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.</h1>
                    ...
                    <div >
                        ...
                        <label>  <span>이용약관에 동의하십니까?</span><input type='checkbox' id='checkOne' onChange={onCH2Handler} className={style.CheckBoxText} name='check2'></input><i className={`fa-regular fa-square-check ${style.notChecked}`} ></i>
                            <i className={`fa-solid fa-square-check ${style.Checked}`}></i>     동의함</label>
                    </div>
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            <br></br>
                            <br></br>2. 수집하는 개인정보 항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 자택 전화번호 , 휴대전화번호 , 이메일 , 14세미만 가입자의 경우 법정대리인의 정보<br></br>
                            <br></br>
                        ...
                        <label>  <span>이용약관에 동의하십니까?</span><input type='checkbox' id='checkTwo' onChange={onCH3Handler} className={style.CheckBoxText} name='check3'></input><i className={`fa-regular fa-square-check ${style.notChecked}`} ></i>
                            <i className={`fa-solid fa-square-check ${style.Checked}`}></i>     동의함</label>
                    </div>
